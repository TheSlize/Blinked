...
public class CommonConfig {
    ...
    public static void loadFromConfig(Configuration config) {
        ...
        closeEyeDuration = createConfigInt(config, "General", "closeEyeDuration", "How many ticks you need to close the 'eyes' (default - 10 ticks)", 5);
        blackScreenDuration = createConfigInt(config, "General", "blackScreenDuration", "How many ticks your 'eyes' are actually closed (default - 5 ticks)", 5);
        openEyeDuration = createConfigInt(config, "General", "openEyeDuration", "How many ticks you need to open the 'eyes' (default - 10 ticks)", 5);
    }
